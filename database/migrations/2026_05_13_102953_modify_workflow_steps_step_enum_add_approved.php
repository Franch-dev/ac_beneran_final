...
return new class extends Migration
{
    ...
    {
        DB::statement("ALTER TABLE workflow_steps MODIFY step ENUM('guest_created','frontdesk_created','spk_invoice_created','spk_invoice_approved','approved','assigned','in_progress','technician_reported','edited_invoice_created','edited_invoice_approved','invoice_edited','payment_received','payment_verified','printed','completed','cancelled')");
    }
