...
<div class="page-container page-operations page-operations--dashboard">
        ...
        <div class="ops-hero__copy">
            ...
            <div class="page-header page-header--hero">
                ...
                <div class="page-actions page-actions--hero">
                    ...
                    @endif
                    <a href="{{ route('modules.ac-masjid-musholla.monitoring') }}" class="btn btn-outline">
    ...
    <section class="search-bar ops-control-bar" data-aos="fade-up" data-aos-delay="120">
        ...
        <form action="{{ route('modules.ac-masjid-musholla.dashboard') }}" method="GET" class="search-form search-form--hero">
            <div class="search-input-wrap">
                <i class="fas fa-search"></i>
                <input type="text" name="search" placeholder="Cari ID atau nama masjid..."
                       value="{{ $searchTerm }}" class="search-input">
                @if($searchTerm)
                    <a href="{{ route('modules.ac-masjid-musholla.dashboard') }}" class="search-clear" aria-label="Hapus pencarian">
...
window.PAGE_SYNC_CONFIG = {
    ...
    snapshotRoute: '{{ route("modules.ac-masjid-musholla.dashboard.snapshot") }}',
    afterRender: 'dashboardRealtimeAfterRender',
};
const ROUTES = {
    masjidStore: '/modules/ac-masjid-musholla/masjid',
    masjidUpdate: (id) => `/modules/ac-masjid-musholla/masjid/${id}`,
    masjidDestroy: (id) => `/modules/ac-masjid-musholla/masjid/${id}`,
    masjidDetail: (id) => `/modules/ac-masjid-musholla/masjid/${id}`,
    acBulk: '/modules/ac-masjid-musholla/ac/bulk',
    acUpdate: (id) => `/modules/ac-masjid-musholla/ac/${id}`,
    acDestroy: (id) => `/modules/ac-masjid-musholla/ac/${id}`,
};
