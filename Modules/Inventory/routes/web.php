...
Route::get('/modules/inventory', InventoryHomeController::class)->name('modules.inventory.index');
...
if ($domain) {
    Route::domain($domain)->group(function (): void {
        Route::get('/', InventoryHomeController::class)->name('modules.inventory.subdomain.index');
    });
}
