...
window.openAssignTech = async function(orderId, orderNumber, masjidName, status) {
    ...
    document.getElementById('assignTechOrderNumber').textContent = String(orderNumber ?? '-');
    document.getElementById('assignTechMasjidName').textContent = String(masjidName ?? '-');
    document.getElementById('assignTechStatus').innerHTML = status
...
window.approveAdditionalFee = function(orderId, orderNumber, masjidName, additionalFee) {
    document.getElementById('approveAdditionalFeeOrderId').value = orderId;
    document.getElementById('additionalFeeOrderNumber').textContent = String(orderNumber ?? '-');
    document.getElementById('additionalFeeMasjidName').textContent = String(masjidName ?? '-');
    document.getElementById('additionalFeeAmount').textContent = additionalFee
