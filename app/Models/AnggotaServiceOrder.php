...
class AnggotaServiceOrder extends Model
{
    ...
    protected $fillable = [
        'anggota_id', 'anggota_custom_id', 'order_number', 'meeting_person',
    ...
    {
        return $this->hasMany(ServiceDetail::class, 'service_order_id');
    }
    ...
    {
        return $this->hasMany(WorkflowStep::class, 'service_order_id')->orderBy('created_at');
    }

    public function latestWorkflowStep()
    {
        return $this->hasOne(WorkflowStep::class, 'service_order_id')->latestOfMany('created_at');
    }

    public function technicianAssignment()
    {
        return $this->hasOne(TechnicianAssignment::class, 'service_order_id');
    }
