...
<head>
    ...
    <title>Invoice - <?php echo e($serviceOrder->order_number); ?></title>
    ...
    <div class="print-document">
        <div class="doc-header">
            ...
            <div class="doc-type">
                ...
                <div class="text-sm">#<?php echo e($serviceOrder->invoice->invoice_number); ?></div>
                <div class="text-sm">Order: <?php echo e($serviceOrder->order_number); ?></div>
            </div>
        </div>
        ...
        <table class="meta-table">
            <tr>
                <td><strong>Tanggal Invoice</strong></td><td>:</td><td><?php echo e($serviceOrder->invoice->created_at->format('d F Y')); ?></td>
                <td><strong>Tanggal Servis</strong></td><td>:</td><td><?php echo e($serviceOrder->service_date->format('d F Y')); ?></td>
            </tr>
            <tr>
                <td><strong>Status</strong></td><td>:</td><td><?php echo e(strtoupper($serviceOrder->status)); ?></td>
                <td><strong>Kontak</strong></td><td>:</td><td><?php echo e($serviceOrder->phone); ?></td>
            </tr>
        </table>

        <div class="section-title">Masjid</div>
        <table class="info-table">
            <tr><td width="28%">Nama</td><td width="5%">:</td><td><?php echo e($serviceOrder->masjid->name); ?></td></tr>
            <tr><td>ID Lokasi</td><td>:</td><td><?php echo e($serviceOrder->masjid->custom_id); ?></td></tr>
            <tr><td>Alamat</td><td>:</td><td><?php echo e($serviceOrder->masjid->address); ?></td></tr>
            <tr><td>DKM</td><td>:</td><td><?php echo e($serviceOrder->masjid->dkm_name); ?></td></tr>
            <tr><td>Marbot</td><td>:</td><td><?php echo e($serviceOrder->masjid->marbot_name); ?></td></tr>
            <tr><td>Telepon</td><td>:</td><td><?php echo e(implode(', ', $serviceOrder->masjid->phone_numbers ?? [])); ?></td></tr>
        </table>
        ...
        <table class="line-table">
            ...
            <tbody>
                <?php $__currentLoopData = $serviceOrder->serviceDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td><?php echo e($i + 1); ?></td>
                    <td><?php echo e($detail->pk_type); ?></td>
                    <td><?php echo e($detail->brand); ?></td>
                    <td><?php echo e($detail->quantity); ?></td>
                    <td>Rp <?php echo e(number_format($detail->price_per_unit, 0, ',', '.')); ?></td>
                    <td>Rp <?php echo e(number_format($detail->quantity * $detail->price_per_unit, 0, ',', '.')); ?></td>
                </tr>
        ...
        <div class="totals">
            <div><strong>Total: Rp <?php echo e(number_format($serviceOrder->invoice->total_price, 0, ',', '.')); ?></strong></div>
        </div>
...
<?php /**PATH C:\Users\Hype G12\ac_beneran_final\resources\views\invoice.blade.php ENDPATH**/ ?>