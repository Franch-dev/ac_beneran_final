...
<head>
    ...
    <title>SPK - <?php echo e($serviceOrder->order_number); ?></title>
...
<body class="print-page">
    ...
    <div class="print-document a4">
        ...
        <div class="spk-meta">
            <table class="meta-table">
                <tr>
                    ...
                    <td width="5%">:</td>
                    <td><strong><?php echo e($serviceOrder->order_number); ?></strong></td>
                    <td width="30%"><strong>Tanggal SPK</strong></td>
                    <td width="5%">:</td>
                    <td><?php echo e($serviceOrder->created_at->format('d F Y')); ?></td>
                </tr>
                <tr>
                    <td><strong>Tanggal Servis</strong></td>
                    <td>:</td>
                    <td><?php echo e($serviceOrder->service_date->format('d F Y')); ?></td>
        ...
        <div class="section-block">
            ...
            <table class="info-table">
                <tr>
                    ...
                    <td width="5%">:</td>
                    <td><?php echo e($serviceOrder->masjid->custom_id); ?></td>
                    <td width="25%">Tipe</td>
                    <td width="5%">:</td>
                    <td><?php echo e(ucfirst($serviceOrder->masjid->type)); ?></td>
                </tr>
                <tr>
                    <td>Nama</td>
                    <td>:</td>
                    <td colspan="3"><?php echo e($serviceOrder->masjid->name); ?></td>
                </tr>
                <tr>
                    <td>Alamat</td>
                    <td>:</td>
                    <td colspan="3"><?php echo e($serviceOrder->masjid->address); ?></td>
                </tr>
                <tr>
                    <td>Ketua DKM</td>
                    <td>:</td>
                    <td><?php echo e($serviceOrder->masjid->dkm_name); ?></td>
                    <td>Marbot</td>
                    <td>:</td>
                    <td><?php echo e($serviceOrder->masjid->marbot_name); ?></td>
                </tr>
                <tr>
                    <td>Yang Ditemui</td>
                    <td>:</td>
                    <td><?php echo e(ucfirst($serviceOrder->meeting_person)); ?></td>
                    <td>Nomor HP</td>
                    <td>:</td>
                    <td><?php echo e($serviceOrder->phone); ?></td>
                </tr>
            </table>
        </div>
            ...
            <table class="work-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($detail->quantity); ?> unit</td>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td><strong><?php echo e($serviceOrder->serviceDetails->sum('quantity')); ?> unit</strong></td>
                        <td></td>
                    </tr>
                </tfoot>
            </table>
        ...
        <div class="section-block">
            ...
            <div class="notes-box"><?php echo e($serviceOrder->notes); ?></div>
        </div>
        <?php endif; ?>
...
<?php /**PATH C:\Users\Hype G12\ac_beneran_final\resources\views\spk.blade.php ENDPATH**/ ?>